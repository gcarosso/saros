...
const App={tab:'cal',tlMode:'ph',calSort:['pd',1],calPage:0,calDense:0,spN:25,fdaF:'nme',fdaPage:0,fdaSort:['d',-1],
  ...
  /* ---- readout calendar ---- */
  renderCal(){
    const cols=[['★','wl',0,'wl'],['Primary completion','pd',1,'readout'],['Δ days','days',1,'days'],['Phase','ph',1,'phase'],['Asset / study','t',0],['Sponsor','grp',1,'sponsor'],['Indication','c',0],['Area','ta',1,'ta'],['Modality','mo',1,'mo'],['Status','st',1,'status'],['N','n',1,'n'],['Conf.','conf',1,'conf'],['Prior','pri',1,'prior'],['Impact','impact',1,'impact'],['Action','action',1,'action'],['Float','mcap',1,'mcap']];
...
function cmp(a,b,k){let x=a[k],y=b[k];if(k==='mcap'){x=a.mcap;y=b.mcap;}if(k==='action'){const o=['Pass','Cash flag','Wait','Review flow','Diligence enrollment','Size / diligence endpoints','Diligence endpoints','Monitor'];x=o.indexOf(a.action);y=o.indexOf(b.action);}if(k==='wl'){x=WL.has(a.id)?1:0;y=WL.has(b.id)?1:0;}if(k==='c'){x=a.c[0]||'';y=b.c[0]||'';}if(x==null)return 1;if(y==null)return -1;return x<y?-1:x>y?1:0;}
